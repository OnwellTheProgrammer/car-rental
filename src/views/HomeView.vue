...
<div class="container">
  <div class="container text-center banner py-5 mt-5">
    ...
    <h5 class="display-6">ROYAL BRAND, ROYAL SERVICES!</h5>
  </div>
</div>
          ...
          <div class="row g-0" id="ourValues" aria-labelledby="ourValuesBtn">
            ...
            <div class="row g-0 p-5 section-description-text">
              <div class="col-lg-5 d-flex">
                <img src="../assets/AppImages/home_page/ceo2.png" class="img-fluid max-h-100-vh" alt="Royalty Ceo">
              </div>
              <div class="col-lg-7">
                <div class="container-fluid pe-xl-0 h-100">
...
export default {
  ...
  data() {
    return {
      ...
      productSize: 0,
      images: [
        require('@/assets/AppImages/home_page/home1.jpg'),
        require('@/assets/AppImages/home_page/home2.jpg'),
        require('@/assets/AppImages/home_page/home3.jpg')
      ],
      swiperOptions: {
        slidesPerView: 1,
        spaceBetween: 10,
