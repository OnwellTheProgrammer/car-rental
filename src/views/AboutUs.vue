    ...
    <div class="row text-start d-flex justify-content-space-between">
      <div class="col-lg-6 col-md-6 col-sm-12 my-3">
        <div class="container-fluid">
          ...
          <li><router-link :to="{ name: 'CountryDetails', params: { country: 'Zimbabwe' } }"><strong>Zimbabwe </strong></router-link>- Harare, Bulawayo</li>
          <li><router-link :to="{ name: 'CountryDetails', params: { country: 'South Africa' } }"><strong>South Africa </strong></router-link>- Johannesburg</li>
          <li><router-link :to="{ name: 'CountryDetails', params: { country: 'Angola' } }"><strong>Angola </strong></router-link>- Luanda</li>
        </div>
      </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 my-3">
        <div class="container-fluid">
          ...
          <li><router-link :to="{ name: 'CountryDetails', params: { country: 'United Kingdom' } }"><strong>United Kingdom </strong></router-link>- London</li>
        </div>
      </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 my-3">
        <div class="container-fluid">
          ...
          <li><router-link :to="{ name: 'CountryDetails', params: { country: 'United Arab Emirates' } }"><strong>United Arab Emirates </strong></router-link>- Dubai</li>
        </div>
      </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 my-3">
        <div class="container-fluid">
          ...
          <li><router-link :to="{ name: 'CountryDetails', params: { country: 'Melbourne' } }"><strong>Melbourne</strong></router-link></li>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="nav-item text-start">
          ...
          <div class="col-12 map-container w-100 bg-light-gray py-4 px-3 py-lg-9">
            <img src="../assets/AppImages/map/map-main.png" class="img-fluid max-h-100-vh" title="Royal Car Rental">
          </div>
        </div>
